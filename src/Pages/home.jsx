    ...
    <div className="bg-gray-800">
      ...
      <section section className="bg-gray-50 py-10" >
        ...
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-6">
          ...
          {/* Card 4: Benda */}
          <CardService title="Lainnya" explain="Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium, placeat harum repellendus tenetur quis error." klass="bg-rose-700">
